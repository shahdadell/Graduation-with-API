class ItemModel {
  ...
  factory ItemModel.fromJson(Map<String, dynamic> json) => ItemModel(
        ...
        serviceRating: double.tryParse(json['service_rating']?.toString() ?? '') ?? 0.0,
        ...
        serviceActive: int.tryParse(json['service_active']?.toString() ?? '') ?? 0,
        ...
        itemsPrice: double.tryParse(json['items_price']?.toString() ?? '') ?? 0.0,
        itemsDiscount: double.tryParse(json['items_discount']?.toString() ?? '') ?? 0.0,
